...
import { formatBD, getFDRStatus } from "../utils/fdrCalc";
      ...
      <div className="glass-card p-5">
        ...
        <div className="space-y-3">
          {fdrs.map((fdr) => {
            ...
            const [colorA, colorB] =
              STATUS_COLORS[status] || STATUS_COLORS["Running"];
      ...
      <div className="glass-card p-5">
        ...
        <div className="space-y-2">
          {fdrs.map((fdr) => {
            ...
            // currentValue and gain are already net of TDS
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className="text-[11px] text-amber-400/80 tabular-nums">
                    Net: Tk {formatBD(Math.round(gain))}
                  </div>
                </div>
              </div>
            );
